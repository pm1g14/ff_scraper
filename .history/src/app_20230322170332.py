...
from utils import JsonUtils as json
from publisher import ZmqPublisher as zmq
...
if __name__ == '__main__':
    ...
    #send with zeromq
    message = json.convertListToJson(list = filteredRows)
    zmq.publish(message=message)
